...
3. **대시보드 서브 탭 (확인 필요 / 기록 상세)**:
   - **[⚠️ 확인 필요] 탭**:
     ...
     - **입실 미입력 학생**: 당일 입실 기록이 아직 없는 학생 명단 (클릭하여 공결 등록 가능한 칩 버튼). 미입력자 없을 시 `✓ 전원 입실 완료` 카드 표시.
     - **퇴실 미입력 학생**: 당일 퇴실 기록이 아직 없는 학생 명단 (클릭하여 공결 등록 가능한 칩 버튼). 미입력자 없을 시 `✓ 전원 퇴실 완료` 카드 표시.
